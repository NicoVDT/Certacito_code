...
- **Changed:** FR-07 target is a single Azure VM running Docker Compose, not App Service plus Key Vault. Reason in the FR-07 row. **Azure is the environment A4 demonstrates**, at `https://app.20-92-93-30.nip.io`; Proxmox was development-only and no longer serves the demo.
